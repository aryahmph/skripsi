...
type (
	...
	InternalGateway struct {
		TimeoutSecond  int            `yaml:"timeout_second" json:"timeout_second"`
		TicketService  TicketService  `yaml:"ticket_service" json:"ticket_service"`
		PaymentService PaymentService `yaml:"payment_service" json:"payment_service"`
	}

	TicketService struct {
		BaseUrl       string `yaml:"base_url" json:"base_url"`
		GetTicketPath string `yaml:"get_ticket_path" json:"get_ticket_path"`
	}

	PaymentService struct {
		BaseUrl        string `yaml:"base_url" json:"base_url"`
		GetPaymentPath string `yaml:"get_payment_path" json:"get_payment_path"`
	}
)
...
type (
	...
	KafkaTopics struct {
		...
		TopicOrderExpire2  string `yaml:"topic_order_expire2" json:"topic_order_expire2"`
		TopicOrderComplete string `yaml:"topic_order_complete" json:"topic_order_complete"`
...
type (
	Cache struct {
		InsertOrderTTLSecond int64 `yaml:"insert_order_ttl_second"`
	}
)
