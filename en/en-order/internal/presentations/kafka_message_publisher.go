...
type (
	MessageExpireOrder struct {
		KafkaMessageBase
		Payload KafkaMessageExpireOrderPayload `json:"payload"`
	}

	MessageOrderComplete struct {
		KafkaMessageBase
		Payload KafkaMessageOrderCompletePayload `json:"payload"`
	}

	KafkaMessageExpireOrderPayload struct {
		ID string `json:"id"`
	}
	...
	KafkaMessageOrderCompletePayload struct {
		ID string `json:"id"`
	}
)
