...
type (
	...
	KafkaNextSecond struct {
		NextCreatePayment int64 `yaml:"next_create_payment" json:"next_create_payment"`
	}
)

type (
	Cache struct {
		InsertPaymentTTLSecond int64 `yaml:"insert_payment_ttl_second"`
	}
)
