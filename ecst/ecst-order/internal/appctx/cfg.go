...
type (
	...
	KafkaTopics struct {
		...
		TopicCreatePayment           string `yaml:"topic_create_payment" json:"topic_create_payment"`
		TopicCreateTicket            string `yaml:"topic_create_ticket" json:"topic_create_ticket"`
		TopicUpdateTicket            string `yaml:"topic_update_ticket" json:"topic_update_ticket"`
	}
	...
	KafkaEETSecond struct {
		...
		EETOrderExpirationComplete int64 `yaml:"eet_order_expiration_complete" json:"eet_order_expiration_complete"`
		EETCreateTicket            int64 `yaml:"eet_create_ticket" json:"eet_create_ticket"`
		EETUpdateTicket            int64 `yaml:"eet_update_ticket" json:"eet_update_ticket"`
		EETCreatePayment           int64 `yaml:"eet_create_payment" json:"eet_create_payment"`
	}

	KafkaConsumerIds struct {
		ConsumerOrderExpire   string `yaml:"consumer_order_expire" json:"consumer_order_expire"`
		ConsumerOrderComplete string `yaml:"consumer_order_complete" json:"consumer_order_complete"`
		ConsumerCreateTicket  string `yaml:"consumer_create_ticket" json:"consumer_create_ticket"`
		ConsumerUpdateTicket  string `yaml:"consumer_update_ticket" json:"consumer_update_ticket"`
		ConsumerCreatePayment string `yaml:"consumer_create_payment" json:"consumer_create_payment"`
	}

	KafkaNextSecond struct {
		NextCreateOrder int64 `yaml:"next_create_order" json:"next_create_order"`
...
type (
	OrderExpire struct {
		...
		DurationSecond int64  `yaml:"duration_second"`
	}
)
