...
const (
	LogMessageFailedToValidateRequestParam = `failed to validate request param, err: %v`
	...
	LogMessageFailedRemoveCache = "failed to remove cache, err: %v"
	...
	LogMessageTicketAlreadyReserved = "ticket already reserved, id: %s"
	...
	LogMessageFailedAddDelayQueue  = "failed to add delay queue, err: %s"
