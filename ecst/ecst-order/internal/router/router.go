...
import (
	...
	"ecst-order/internal/middleware"
	repository "ecst-order/internal/repositories"
	"ecst-order/internal/ucase"
	ucaseContract "ecst-order/internal/ucase/contract"
	"ecst-order/internal/ucase/v1/order"
...
func (rtr *router) Route() *routerkit.Router {
	...
	createOrder := order.NewCreateOrder(kp, dqp, orderRepo, ticketRepo)
